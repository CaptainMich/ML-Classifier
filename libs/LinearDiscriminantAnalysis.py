...
class LDA(object):
    """This class performs Linear Discriminant Analysis algorithm
    """
    ...
    def train(self):
        ...
        self.model = self.lda.fit(self.data_train, self.label_train)
    ...
    def plot_precision_recall_f1(self, classes=['Won','Loss'], display=False):
        ...
        visualizer = ClassificationReport(self.lda, classes=classes)
        ...
        visualizer.poof(outpath=self.cfg['plot_path'] + "lda-report.png") # save the data
        if display:
    ...
    def confusion_matrix(self, classes=['Won','Loss'], display=False):
        ...
        for title, normalize in titles_options:
            ...
            plt.savefig(self.cfg['plot_path'] + f"lda-confusion-matrix{text}.png")
    ...
    def plot_decision_boundary(self, 
        ...
        # we fit the data using the LDA Classifier
        self.lda.fit(x_mat, y_mat)
        ...
        plt.savefig(self.cfg['plot_path'] + "lda-decision-boundary.png")
    ...
    def generate_report(self):
        ...
        pdf.cell(0, 30, 'LDA', border=0, ln=2, align='C')
        ...
        # Plot Report
        pdf.cell(10)
        pdf.image(self.cfg['plot_path'] + "lda-report.png", x = 30, y = 40, w = 150, h = 100, type = '', link = '')
        ...
        pdf.cell(0)
        pdf.image(self.cfg['plot_path'] + "lda-confusion-matrix.png", x = 20, y = 160, w = 100, h = 75, type = '', link = '')  
        pdf.cell(10)
        pdf.image(self.cfg['plot_path'] + "lda-confusion-matrix-normalize.png", x = 100 , y = 160, w = 100, h = 75, type = '', link = '')
        ...
        pdf.image(self.cfg['plot_path'] + "lda-decision-boundary.png", x = 20, y = 30, w = 180, h = 120, type = '', link = '')
        pdf.output(self.cfg['info_path'] + 'lda-report.pdf', 'F')
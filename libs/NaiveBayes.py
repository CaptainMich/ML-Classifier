...
class NaiveBayes(object):
    """This class performs Naive Bayes algorithm
    """
    ...
    def train(self):
        ...
        self.model = self.gnb.fit(self.data_train, self.label_train)
    ...
    def plot_precision_recall_f1(self, classes=['Won','Loss'], display=False):
        ...
        visualizer = ClassificationReport(self.gnb, classes=classes)
        ...
        visualizer.poof(outpath=self.cfg['plot_path'] + "naive-bayes-report.png") # save the data
        if display:
    ...
    def confusion_matrix(self, classes=['Won','Loss'], display=False):
        ...
        for title, normalize in titles_options:
            ...
            plt.savefig(self.cfg['plot_path'] + f"naive-bayes-confusion-matrix{text}.png")
    ...
    def plot_decision_boundary(self, 
        ...
        # we fit the data using the Naive-Bayes Classifier
        self.gnb.fit(x_mat, y_mat)
        ...
        Z = self.gnb.predict(np.c_[xx.ravel(), yy.ravel()])
        ...
        plt.savefig(self.cfg['plot_path'] + "naive-bayes-decision-boundary.png")
    ...
    def generate_report(self):
        ...
        # Plot Report
        pdf.cell(10)
        pdf.image(self.cfg['plot_path'] + "naive-bayes-report.png", x = 30, y = 40, w = 150, h = 100, type = '', link = '')
        ...
        pdf.cell(0)
        pdf.image(self.cfg['plot_path'] + "naive-bayes-confusion-matrix.png", x = 20, y = 160, w = 100, h = 75, type = '', link = '')  
        pdf.cell(10)
        pdf.image(self.cfg['plot_path'] + "naive-bayes-confusion-matrix-normalize.png", x = 100 , y = 160, w = 100, h = 75, type = '', link = '')
        ...
        pdf.image(self.cfg['plot_path'] + "naive-bayes-decision-boundary.png", x = 20, y = 30, w = 180, h = 120, type = '', link = '')
